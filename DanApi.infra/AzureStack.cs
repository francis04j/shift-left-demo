...
class AzureStack : Stack
{
    public AzureStack()
    {
        ...
        // Resource Group
        var rg = new ResourceGroup("rg-danapi-uks-");

        // AppService Plan
        var appServicePlan = new AppServicePlan("appplan-danapi-uks-", new AppServicePlanArgs() {
        ...
        var app = new WebApp("app-danapi-uks-", new WebAppArgs() 
        { 
            ResourceGroupName = rg.Name,
